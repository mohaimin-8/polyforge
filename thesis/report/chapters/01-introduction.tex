...
substrates --- and both arms are live-verified end to end; the
pre-registered ordinal check recorded a \emph{disagreement} (live parity
between the arms at the replica-only projection), published as measured in
