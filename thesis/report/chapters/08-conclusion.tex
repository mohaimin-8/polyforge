...
\begin{itemize}
  \item \textbf{The live \jcac{} slice.} The one remaining measurement:
        the jcac smoke and full ordinal runs on a Docker-capable machine,
        under the already-frozen protocol and caption
        (\evfile{PHASE7\_JCAC\_PLAN.md}). Everything is wired and gated;
        the result will be reported ordinal-only whichever way it lands.
