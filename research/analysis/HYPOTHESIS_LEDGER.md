...
| quantity | value |
|---|---:|
| records contributing tests | 16 |
| scored tests with a p-value | 73 |
| registered PASS among them | 50 |
| PASS surviving programme-wide Holm at 0.05 (family-wise) | 42 |
| PASS surviving programme-wide Benjamini–Yekutieli at 0.05 (FDR, any dependence) | 48 |

A further **54** scored tests in 13 records carry a verdict but no p-value (confidence-interval and rule-based readings; 32 PASS). They cannot enter a p-value correction and are not counted above.
...
|---|---|---|---:|---:|---|
| `RESULTS_FAIR_J.md` | Secondary: comparators carrying the budget rule (own Holm family of 2; not confirmatory) | FJ-S1 | 0.0329 | 0.0029 | no |
| `RESULTS_RISK_BUDGET.md` | RB-H1 (confirmatory) — does the corrected knob buy attainment? | violation, q90c − point (want < 0) | 0.00733 | 0.0023 | no |
| `RESULTS_MODEL_MISMATCH.md` | MM-H1 and MM-H2 (one Holm family of 12, α = 0.05) | MM-H1[tier0.75] | 0.00319 | 0.0022 | yes |
| `RESULTS_FAIR_J.md` | Confirmatory: FJ-H1..H3 (one Holm family of 3) | FJ-H2 | 0.00288 | 0.0021 | yes |
| `RESULTS_TENANT_SCALE.md` | TS-H1b (confirmatory, large-effects power) — 64 tenants | HPA | 0.00239 | 0.002 | yes |
| `RESULTS_TENANT_SCALE.md` | TS-H1b (confirmatory, large-effects power) — 64 tenants | Concurrency (KPA shape) | 0.00217 | 0.0019 | yes |
| `RESULTS_TRACE_PARITY.md` | Azure LLM 2024 (72 x 3 h, `PREREG_TRACE_AZURE.md` protocol) / Hypotheses (Holm-corrected w | TP-H3a | 0.002 | 0.0018 | yes |
| `RESULTS_TRACE_PARITY.md` | Azure LLM 2024 (72 x 3 h, `PREREG_TRACE_AZURE.md` protocol) / Hypotheses (Holm-corrected w | TP-H3b | 0.002 | 0.0019 | yes |
